...
db = create_engine(engine_url)
db.execute("""
    CREATE TABLE digital_eng (
        "key_id" text NOT NULL,
        "adv_list_eng" text NOT NULL,
        "art3_list_eng" text NOT NULL,
        "ad_placement" text,
        "use_type" text NOT NULL,
        "subbr_list_eng" text NOT NULL,
        "day" date NOT NULL,
        "week" date NOT NULL,
        "month" date NOT NULL,
        "ad_network" text,
        "br_list_eng" text NOT NULL,
        "mod_list_eng" text NOT NULL,
        "media_product" text NOT NULL,
        "ad_source_type" text NOT NULL,
        "art2_list_eng" text NOT NULL,
        "id" integer NOT NULL,
        "ad_player" text,
